...
from detic.context_modelling.context_modelling_v2 import ContextModellingV2 as ContextModelling
from time import time
from torchvision.ops import box_iou


@ROI_HEADS_REGISTRY.register()
class CustomStandardROIHeadsV2(StandardROIHeads):
    @configurable
    ...
    def label_and_sample_proposals(self, proposals, targets, ann_types, image_ids):
        ...
        for proposals_per_image, targets_per_image, ann_type, image_id \
            ...
            added_instances, group_info = self.context_modeling.sample(image_id, proposals_per_image,
                                                                       self.mask_on)
