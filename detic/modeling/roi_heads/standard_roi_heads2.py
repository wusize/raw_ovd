...
class StandardROIHeadsV2(StandardROIHeads):
    ...
    def _forward_box(self, features, proposals,
        ...
        if self.training:
            ...
            if self.context_modeling_cfg.ENABLE:
                losses.update(self.context_modeling.get_loss(group_infos, clip_images, image_info, features, self))
    ...
    def label_and_sample_proposals(self, proposals, targets, ann_types):
        ...
        for proposals_per_image, targets_per_image, ann_type in zip(proposals, targets, ann_types):
            ...
            group_info.update(instances=added_instances)
            ...
            # proposals_per_image = Instances.cat([proposals_per_image, added_instances])   # do not add to proposals
    ...
    def _box_forward_train(self, box_features, proposals):
        ...
        predictions = dict(
            ...
            scores=scores, proposal_deltas=proposal_deltas)
