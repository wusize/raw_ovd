...
class AddConvStandardROIHeads(StandardROIHeads):
    @configurable
    ...
    @staticmethod
    def _get_add_conv(in_channels, out_channels, activation=nn.ReLU()):
        return Conv2d(
            in_channels,
            out_channels,
            kernel_size=3,
    ...
    def forward(self, images, features, proposals, targets=None,
        ...
        all_feature_names = set(self.box_in_features + getattr(self, "mask_in_features", []))
