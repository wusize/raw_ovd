...
__all__ = [
    "wusize_build_detection_train_loader",
]
...
class WusizeDatasetMapper(DatasetMapper):
...
def load_proposals_into_dataset(dataset_dicts, proposal_file):
    ...
    for record in dataset_dicts:
        ...
        if 'is_novel' in proposals:
            is_novel = proposals['is_novel'][i][inds]
            record["proposal_is_novel"] = is_novel
...
def _train_loader_from_config(cfg, mapper=None, *, dataset=None, sampler=None):
    ...
    if mapper is None:
        mapper = WusizeDatasetMapper(cfg, True)
