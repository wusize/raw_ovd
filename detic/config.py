...
def add_detic_config(cfg):
    ...
    _C.CONTEXT_MODELLING.PROMPT_LENGTH = 1

    _C.CONTEXT_MODELLING.VERSION = ''
    _C.CONTEXT_MODELLING.USE_BOX_POSITION = False

    _C.MODEL.ROI_BOX_HEAD.NO_REG = False
    _C.SAVE_PREDICTIONS = True

    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS = CN()
    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS.ENABLE = False
    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS.TEST = False
    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS.WEIGHT = 0.01
    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS.PATH = 'datasets/metadata/coco_clip_word_embeddings.npy'
    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS.METRIC = 'cosine'   # "n1", "n2"
    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS.TEMPERATURE = 25.0
    _C.MODEL.ROI_BOX_HEAD.WORD_EMBEDDINGS.BIAS = 0.0
    # TODO: use positional encoding
    _C.MODEL.ROI_BOX_HEAD.POSITIONAL_ENCODING = CN()
    _C.MODEL.ROI_BOX_HEAD.POSITIONAL_ENCODING.APPLY_TO_BASE = True
    _C.MODEL.ROI_BOX_HEAD.POSITIONAL_ENCODING.ENABLE = False
    _C.MODEL.ROI_BOX_HEAD.POSITIONAL_ENCODING.NUM_WORDS = 1

    _C.CONTEXT_MODELLING_V4 = _C.CONTEXT_MODELLING.clone()
    _C.CONTEXT_MODELLING_V4.CHECKBOARD.SHAPE_RATIO_THR = [0.25] * 4
    _C.CONTEXT_MODELLING_V4.CHECKBOARD.NMS_THR = [0.10] * 4
    _C.CONTEXT_MODELLING_V4.CHECKBOARD.AREA_THR = [-1, 112, 224, -1]
    _C.CONTEXT_MODELLING_V4.CHECKBOARD.OBJECTNESS_THR = [0.9, 0.9, 0.85, 0.85]
    _C.CONTEXT_MODELLING_V4.CHECKBOARD.AREA_RATIO_THR = 0.0004
