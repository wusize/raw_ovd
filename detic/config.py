...
def add_detic_config(cfg):
    ...
    # TODO: use prompting
    _C.MODEL.ROI_BOX_HEAD.PROMPTING = CN()
    _C.MODEL.ROI_BOX_HEAD.PROMPTING.ENABLE = False
    _C.MODEL.ROI_BOX_HEAD.PROMPTING.NUM_WORDS = 1

    _C.CONTEXT_MODELLING.PROMPTING = CN()
    _C.CONTEXT_MODELLING.PROMPTING.ENABLE = False
    _C.CONTEXT_MODELLING.PROMPTING.NUM_WORDS = 1
    _C.CONTEXT_MODELLING.PROMPTING.POSITION_AWARE = True
