...
def add_detic_config(cfg):
    ...
    _C.MODEL.DETR.DEEP_SUPERVISION = False
    ...
    _C.MODEL.ROI_BOX_HEAD.ENSEMBLE_FACTOR = 0.67
    _C.MODEL.ROI_BOX_HEAD.TRANSFER = -1.0
    _C.MODEL.ROI_BOX_HEAD.NOVEL_FACTOR = 1.0
    _C.MODEL.ROI_BOX_HEAD.RESCALE_TEMP = 1.0
