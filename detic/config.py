...
def add_detic_config(cfg):
    ...
    _C.CONTEXT_MODELLING.QUEUE.MAX_UPDATE = 128
    ...
    _C.CONTEXT_MODELLING.SPLIT_PER_LEVEL = [16, 8, 4, 2]
    _C.CONTEXT_MODELLING.STEP_PER_LEVEL = [8, 4, 2, 1]       # NUM_STEPS = [4, 4, 4, 2]
    _C.CONTEXT_MODELLING.MAX_GROUPS_PER_SAMPLE = [1, 1, 1, 1]
    _C.CONTEXT_MODELLING.NUM_SAMPLES_PER_STEP = [8, 4, 2, 1]
    _C.CONTEXT_MODELLING.MAX_PERMUTATIONS = 2
    _C.CONTEXT_MODELLING.ALPHA = 2.0
    _C.CONTEXT_MODELLING.INTERVAL = -0.2
    _C.CONTEXT_MODELLING.BASE_PROBABILITY = [0.3, 0.3, 0.3, 0.3]
