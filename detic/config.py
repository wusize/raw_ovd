...
def add_detic_config(cfg):
    ...
    _C.MODEL.CLIP_RESNET = CN()
    _C.MODEL.CLIP_RESNET.NAME = 'RN50'
    _C.MODEL.CLIP_RESNET.MODEL_ROOT = 'models'
    ...
    _C.CONTEXT_MODELLING.OUT_DIM = 512
    ...
    _C.CONTEXT_MODELLING.MAX_VALID_PROPOSALS = 1000000000000000000000000000000000

    _C.CONTEXT_MODELLING.GRAB = CN()
    _C.CONTEXT_MODELLING.GRAB.DENSE_NMS_THR = 0.5
    _C.CONTEXT_MODELLING.GRAB.DENSE_OBJECTNESS_THR = 0.8
    _C.CONTEXT_MODELLING.GRAB.NUM_PERMS = 1
    _C.CONTEXT_MODELLING.GRAB.GIOU_THR = -0.5
    _C.CONTEXT_MODELLING.GRAB.MAX_CANDIDATES = 2

    _C.MODEL.ROI_BOX_HEAD.WORD_PRED_LAYERS = 1
